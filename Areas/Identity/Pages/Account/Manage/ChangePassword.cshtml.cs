...
namespace EduSchool.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "A {0} legalább {2} és legfeljebb {1} karakterből állhat.", MinimumLength = 6)]
            [DataType(DataType.Password)]
            ...
            [Compare("NewPassword", ErrorMessage = "Az új jelszó és a megerősítő jelszó nem egyezik.")]
